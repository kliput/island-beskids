...
return Object.defineProperty(a,"__esModule",{value:!0}),a}catch(t){throw new Error('Could not read config from meta tag with name "'+e+'".')}}),runningTests||require("island-beskids/app").default.create({name:"island-beskids",version:"0.0.0+190baccb"})
